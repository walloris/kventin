...
Раньше всё это жило в agent/agent.py. Вынесено сюда — модуль изолирован,
...
from agent.defects.defect_pipeline import create_defect
from agent.defects.defect_rules import rule_page_load_errors
...
def check_page_load_and_report(
    ...
    *,
    ...
    from agent.actions.locators import url_pattern as _url_pattern  # локально, без циклов
