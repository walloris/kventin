...
from agent.actions.form_strategies import detect_field_type, get_test_value, get_form_fill_strategy
from agent.checks.accessibility import check_accessibility, format_a11y_issues
...
from agent.defects.jira_client import create_jira_issue, reset_session_defects
...
from agent.core.checklist import run_checklist, checklist_results_to_context, build_checklist
...
# Резолверы и обогащение действий вынесены в agent/element_resolver.py
from agent.actions.element_resolver import (
    enrich_action,
...
# AgentMemory вынесен в agent/agent_memory.py — здесь только реэкспорт
...
def _step_checklist_incremental(
    ...
    """
    from agent.core.checklist import build_checklist
...
def _step_post_analysis_LEGACY(
    ...
    from agent.defects.defect_rules import is_noise_url, is_noise_console_text
    new_errors = [
...
Баг или нормальное поведение? Если баг — JSON с action=check_defect и possible_bug."""
        ...
        from agent.defects.defect_rules import rule_pageerror as _rule_pe
...
# Создание дефекта вынесено в agent/defect_pipeline.py (вместе с фоновой
...
# A11y, perf, responsive, iframe, scenario chains вынесены в agent/agent_checks.py.
