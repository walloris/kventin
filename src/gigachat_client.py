...
ВСЕГДА отвечай СТРОГО в формате JSON (без markdown, без ```, без пояснений):
{
  ...
  "observation": "что вижу на скриншоте (кратко)",
...
{"action": "click", "selector": "Войти", "value": "", "reason": "Проверяю кнопку входа", "test_goal": "Проверяю переход на форму логина", "expected_outcome": "Откроется форма логина или переход на страницу входа", "observation": "Вижу кнопку Войти", "possible_bug": null}"""
