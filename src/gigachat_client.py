...
3) Предпочитай КЛИКИ и ВВОД. Scroll — только если нечего кликнуть на экране.
4) Кликай на ВСЕ кнопки, ссылки, элементы меню. Заполняй ВСЕ формы.
...
9) НЕ предлагай "explore" — предлагай КОНКРЕТНОЕ действие (click/type)!
